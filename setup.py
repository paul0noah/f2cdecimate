...
setup(
    name='Fine-to-Coarse-Decimation',
    version='0.0.1',
    description='Fine-to-Coarse Decimation built upon libigl. Is probably very slow.',
    packages=find_packages(),
    ext_modules=[CMakeExtension(name='fine2coarsedec')],
